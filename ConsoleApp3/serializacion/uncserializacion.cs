...
namespace ConsoleApp3.Serializacion
{
    public class Serializador
    {
        ...
        public Serializador()
        {
            // Configurar las opciones de serialización para manejar tipos polimórficos y el Color4Converter
            opciones = new JsonSerializerOptions
            {
                WriteIndented = true, // Para una mejor legibilidad del JSON
                PropertyNameCaseInsensitive = true,
                Converters =
                {
                    new JsonStringEnumConverter(),
                    new Color4Converter() // Agregamos el convertidor personalizado
                },
    ...
    // Resolver personalizado para manejar tipos polimórficos
