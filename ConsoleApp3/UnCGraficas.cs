...
namespace ConsoleApp3
{
    public class UnCGraficas : GameWindow
    {
        ...
        private Escenario escenario = new Escenario(Color4.Black);
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //UncObjeto objeto = CrearObjetoEnFormaDeT();

            //// Serializar el objeto
            //ser.Serializar(objeto, "ObjetoT");
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            double velocidadRotacion = 40.0;

            anguloRotacion += velocidadRotacion * e.Time;
            ...
            TransformarElemento(objeto1, "Rotar", 0.0, 0.0, velocidadRotacion * e.Time, "CentroEscenario");

            // Rotar el segundo objeto
            Figura3D objeto2 = escenario.ObtenerFigura("objetoT_CentroObjeto");

            //TransformarElemento(objeto2, "Rotar", velocidadRotacion * e.Time, 0.0, 0.0, "CentroObjeto");
            ...
            if (objeto2 is UncObjeto uncObjeto)
            {
                ...
                if (parte != null)
                {
                    TransformarElemento(parte, "Rotar", 0.0, velocidadRotacion * e.Time, 0.0, "CentroEscenario");
                }
                Figura3D parte2 = uncObjeto.ObtenerParte("rectanguloVertical");
                if (parte2 != null)
                {
                    TransformarElemento(parte2, "Rotar", velocidadRotacion * e.Time, 0.0, 0.0, "CentroParte");
                }
                Figura3D caraFrontal = uncObjeto.ObtenerParte("rectanguloVertical").ObtenerPoligono("caraFrontal");
                if (caraFrontal != null)
                {
                    TransformarElemento(caraFrontal, "Rotar",0.0, velocidadRotacion * e.Time, 0.0, "CentroEscenario");
                }
